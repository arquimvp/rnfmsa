...
import {View, StyleSheet, ViewStyle, StyleProp, KeyboardAvoidingView, Platform, ViewProps} from 'react-native';
...
const Container = forwardRef(
  (
    ...
    const {blockStyle, rowStyle, centerStyle, middleStyle, crossCenterStyle} = styles;
    ...
    const styleBlock: ViewStyle[] = [
      ...
      circle
        ? {
            borderRadius: typeof width === 'number' && typeof height === 'number' ? width + height : 1000,
            overflow: 'hidden',
          }
        : {},
    ...
    return (
      <View ref={ref} testID={testID} style={[styleBlock, style]} collapsable={false} onLayout={onLayout}>
        {children}
      </View>
    );
  },
